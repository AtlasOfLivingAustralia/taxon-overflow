<g:form name="answerForm" controller="webService" action="submitAnswer" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <g:textField class="form-control taxon-select taxon-select-scientific" name="scientificName" placeholder="Enter a scientific name"/>
                            <g:hiddenField class="answer-field taxon-select-guid" name="taxonConceptID"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="commonName" class="col-sm-3 control-label">Common name</label>
                        <div class="col-sm-8">
                            <g:textField class="form-control taxon-select-common" name="commonName" placeholder="Enter a common name"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="taxonConceptID" class="col-sm-3 control-label">Comments or remarks</label>
                        <div class="col-sm-8">
                            <g:textArea class="form-control" name="description" placeholder="Enter your comments or remarks" rows="4"></g:textArea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" id="submitAnswerButton">Add identification</button>
                </div>
            </div>
        </div>
    </div>
